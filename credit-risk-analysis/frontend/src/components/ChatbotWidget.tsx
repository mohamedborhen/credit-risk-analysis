...
export default function ChatbotWidget() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    if (!userId) {
      setError("Please log in first so the assistant can fetch your score context.");
      return;
    }
